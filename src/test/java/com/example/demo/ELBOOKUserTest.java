...
public class ELBOOKUserTest {
	...
	void targetUser() {
		...
		assertEquals(15, userList.getUser_id());
		assertEquals("city", userList.getUser_name());
		assertEquals("test@com", userList.getMail());
		assertEquals("92e7d0ed04e062d134b011232169e07634bb34e4f745a22db05e5a676e778b1d358a028ad7d37b01", userList.getPass());
		assertEquals("ADMIN", userList.getAuthority());
	}
	...
	void createUserAdmin() {
		...
		UserList resultList = userService.targetUser(20);
